...
{
    private Label PrimaryColorLabel   { get; set; } = null!;
    private Entry PrimaryColorEntry   { get; set; } = null!;
    private Label SecondaryColorLabel { get; set; } = null!;
    private Entry SecondaryColorEntry { get; set; } = null!;
    private Label TertiaryColorLabel  { get; set; } = null!;
    private Entry TertiaryColorEntry  { get; set; } = null!;

    private Label DefaultPrimaryColorLabel   { get; set; } = null!;
    private Entry DefaultPrimaryColorEntry   { get; set; } = null!;
    private Label DefaultSecondaryColorLabel { get; set; } = null!;
    private Entry DefaultSecondaryColorEntry { get; set; } = null!;
    private Label DefaultTertiaryColorLabel  { get; set; } = null!;
    private Entry DefaultTertiaryColorEntry  { get; set; } = null!;

    private Label  PaidToTurnOffAdsLabel  { get; set; } = null!;
    private Switch PaidToTurnOffAdsSwitch { get; set; } = null!;

    private Label AwesomePersonScoreLabel { get; set; } = null!;
    private Entry AwesomePersonScoreEntry { get; set; } = null!;

    private Label LastSortOptionLabel { get; set; } = null!;
    private Entry LastSortOptionEntry { get; set; } = null!;

    private Label  HideStartupMessageLabel  { get; set; } = null!;
    private Switch HideStartupMessageSwitch { get; set; } = null!;

    private Label ErrorReportingIdLabel { get; set; } = null!;
    private Entry ErrorReportingIdEntry { get; set; } = null!;

    private StackLayout StackLayout { get; set; } = null!;
    ...
    private static Label BuildErrorReportingIdLabel()
    {
    ...
    private static Entry BuildErrorReportingIdEntry()
    {
        ...
        errorReportingIdEntry.TextChanged += (sender, e) =>
        {
    ...
    private static Entry BuildDefaultPrimaryColorEntry()
    {
        ...
        defaultPrimaryColorEntry.TextChanged += (sender, e) =>
        {
