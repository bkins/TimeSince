...
public partial class MainPage : ContentPage
{
    ...
    private void ScrollToFirstItemInListView()
    {
        ...
        ScrollToItemInListView(firstItem
    ...
    private void ScrollToLastItemInListView()
    {
        ...
        ScrollToItemInListView(lastItem
                             , ScrollToPosition.End);
    }

    private void ScrollToItemInListView(object?           item
                                      , ScrollToPosition position)
    {
        if (item is not null)
        {
            EventsListView.ScrollTo(item
                                  , position
                                  , true);
        }
    }
                                        ...
                                        , EventArgs e)
    {
        ...
        else
        {
            await DisplayAlert("Error"
                             , "Please check the privacy policy acceptance checkbox to continue."
                             , "OK");
        }
    }
    ...
    private void SetButtonsTextColor()
    {
        ...
        AddEventButton.TextColor = buttonTextColor ?? Colors.Black;
    }
}
