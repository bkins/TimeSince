...
public class LogLine
{
    ...
    public string MessageAsHtml => $"<p style=\"color:{ColorInfo.Gray}\">{Message}</p>";
    ...
    private static string? StyleTextWithColor(string? text
                                            , string  color)
    {
        ...
        if (lines is null) return htmlLines.ToString();
